...
class NodeManager(object):
    ...
    def url_manager_proc(self,url_q,conn_q,root_url):
        '''
        url管理 进程
        :param url_q: Queue 给分节点分发url
        :param conn_q: Queue 从本地进程获取新url
        :param root_url: 启动的url
        :return:
        '''
    ...
    def result_solve_proc(self,result_q,conn_q,store_q):
        '''
        数据提取进程
        :param result_q: Queue 获取分节点爬取的结果
        :param conn_q: Queue 给本地进程添加分节点添加的新url
        :param store_q: Queue 给本地进程添加分节点爬取的数据
        :return:
        '''
        while(True):
            try:
    ...
    def store_proc(self,store_q):
        '''
        存储进程
        :param store_q: Queue 从本地进程获取爬取的数据
        :return:
        '''
        output = DataOutput()
        while True:
